# Small Projects Portfolio & Skill Labs
...
* Click on the **project link** in the table to navigate to its specific directory and view the detailed `README.md` for build instructions and usage.
* The source code for each project is fully contained within its respective folder.
